...
### 2. Safety Breakdown
Rate each factor:
- Contract verification: ✅ Verified / ⚠️ Unverified / ❌ Proxy
- Ownership: ✅ Renounced / ⚠️ Active / ❌ Suspicious
- Liquidity: 💧 Deep (>$500k) / 💧 Medium ($50k-$500k) / 🏜️ Thin (<$50k)
- Token tax: ✅ None / ⚠️ Low (<5%) / ❌ High (>5%)
- Holder distribution: ✅ Distributed / ⚠️ Concentrated / ❌ Whale-heavy
...
- ⚠️ Caution — multiple red flags, small position only
- 🚫 Avoid — honeypot, rug indicators, or extreme risk
