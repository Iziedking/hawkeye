...
- Check for these red flags and REFUSE to proceed if any are found:
  - Honeypot detected
  - Buy/sell tax above 5%
  - Unverified/unaudited contract
  - Ownership not renounced
  - Liquidity not locked
- Suggest conservative position sizes: "start with 0.01-0.05 ETH max"
